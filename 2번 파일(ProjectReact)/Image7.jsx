...
<body>
  <h1>경복궁</h1>
  <img src="${process.env.PUBLIC_URL}/image6.jpg" alt="Description for Korea">
...
`);
  ...
  return (
    <div className="image-item image7" onClick={handleClick}>
      <img
        src={`${process.env.PUBLIC_URL}/image6.jpg`} // Here you might want to use image7.jpg if that's the correct image file.
