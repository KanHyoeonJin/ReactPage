...
function VacationSpots() {
  const handleClick = () => {
    ...
    newWindow.document.write(`
      ...
      <body>
        <h1>경복궁</h1>
        <img src="${process.env.PUBLIC_URL}/image3.jpg" alt="Description for Image 3">
        <p>경복궁에 대한 설명...</p>
  ...
  return (
    <div className="image-item VacationSpots" onClick={handleClick}>
      <img
        src={`${process.env.PUBLIC_URL}/VacationSpots_2.jpg`}
